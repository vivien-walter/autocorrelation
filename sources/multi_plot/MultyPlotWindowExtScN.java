...
/*	MultyPlotWindowExtScN for displaying of multiple lines plot
...
public class MultyPlotWindowExtScN extends ImageWindow implements ActionListener, ClipboardOwner {
	...
	private static MultyPlotExtScN staticPlot;
	private MultyPlotExtScN plot;
	...
	// static initializer
	static {
		IJ.register(MultyPlotWindowExtScN.class); //keeps options from being reset on some JVMs
...
//		saveXValues = (options&SAVE_X_VALUES)!=0;
	...
	*/
	public MultyPlotWindowExtScN(String title, String xLabel, String yLabel, float[] xValues, float[] yValues) {
		super(createImage(title, xLabel, yLabel, xValues, yValues));
		plot = staticPlot;
	}

	/** This version of the constructor excepts double arrays. */
	public MultyPlotWindowExtScN(String title, String xLabel, String yLabel, double[] xValues, double[] yValues) {
		this(title, xLabel, yLabel, Tools.toFloat(xValues), Tools.toFloat(yValues));
		initDigits();
	}

	/** Creates a PlotWindow from a Plot object. */
	MultyPlotWindowExtScN(MultyPlotExtScN plot) {
	...
	static ImagePlus createImage(String title, String xLabel, String yLabel, float[] xValues, float[] yValues) {
		staticPlot = new MultyPlotExtScN(title, xLabel, yLabel, xValues, yValues);
...
//			cf.setRestarts(2);
	...
	public void drawPlot(MultyPlotExtScN plot) {
		this.plot = plot;
