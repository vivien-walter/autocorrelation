...
public class MultyPlotExtScN {
	...
	*/
	public MultyPlotExtScN(String title, String xLabel, String yLabel, float[] xValues, float Ymin, float Ymax) {
		this.title = title;
		this.xLabel = xLabel;
		this.yLabel = yLabel;
...
//		a = Tools.getMinMax(yValues);
	...
	public MultyPlotExtScN(String title, String xLabel, String yLabel, float[] xValues, float[] yValues) {
		this.title = title;
		this.xLabel = xLabel;
		this.yLabel = yLabel;
		this.xValues = xValues;
//		this.yValues = yValues;
	...
	public MultyPlotExtScN(String title, String xLabel, String yLabel, double[] xValues, double[] yValues) {
...
//		new ImagePlus("after", label).show();
	...
	public MultyPlotWindowExtScN show() {
		draw();
		return new MultyPlotWindowExtScN(this);
	}
